...
/**
 * Model-aware overloads for the `CostCenters` resource.
 *
 ...
 * CRUD overloads with concrete `CostCenterData` return types so static analysers
 ...
 * @see LaravelWafeq
 */
trait InteractsWithCostCentersModel
{
