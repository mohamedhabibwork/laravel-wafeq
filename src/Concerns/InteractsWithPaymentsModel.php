...
/**
 * Model-aware overloads for the `Payments` resource.
 *
 ...
 * CRUD overloads with concrete `PaymentData` return types so static analysers
 ...
 * @see LaravelWafeq
 */
trait InteractsWithPaymentsModel
{
