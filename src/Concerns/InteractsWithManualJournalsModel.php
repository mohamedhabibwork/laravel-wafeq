...
/**
 * Model-aware overloads for the `ManualJournals` resource.
 *
 ...
 * CRUD overloads with concrete `ManualJournalData` return types so static analysers
 ...
 * @see LaravelWafeq
 */
trait InteractsWithManualJournalsModel
{
