...
/**
 * Model-aware overloads for the `PurchaseOrders` resource.
 *
 ...
 * CRUD overloads with concrete `PurchaseOrderData` return types so static analysers
 ...
 * @see LaravelWafeq
 */
trait InteractsWithPurchaseOrdersModel
{
