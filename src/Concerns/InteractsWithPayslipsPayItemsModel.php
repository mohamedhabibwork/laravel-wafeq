...
/**
 * Model-aware overloads for the `PayslipsPayItems` resource.
 *
 ...
 * CRUD overloads with concrete `PayslipPayItemData` return types so static analysers
 ...
 * @see LaravelWafeq
 */
trait InteractsWithPayslipsPayItemsModel
{
