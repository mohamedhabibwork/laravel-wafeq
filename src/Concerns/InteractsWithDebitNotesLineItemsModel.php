...
/**
 * Model-aware overloads for the `DebitNotesLineItems` resource.
 *
 ...
 * CRUD overloads with concrete `DebitNoteLineItemData` return types so static analysers
 ...
 * @see LaravelWafeq
 */
trait InteractsWithDebitNotesLineItemsModel
{
