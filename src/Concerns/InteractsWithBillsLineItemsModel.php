...
/**
 * Model-aware overloads for the `BillsLineItems` resource.
 *
 ...
 * CRUD overloads with concrete `BillLineItemData` return types so static analysers
 ...
 * @see LaravelWafeq
 */
trait InteractsWithBillsLineItemsModel
{
