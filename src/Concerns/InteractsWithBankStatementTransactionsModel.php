...
/**
 * Model-aware overloads for the `BankStatementTransactions` resource.
 *
 ...
 * CRUD overloads with concrete `BankStatementTransactionData` return types so static analysers
 ...
 * @see LaravelWafeq
 */
trait InteractsWithBankStatementTransactionsModel
{
