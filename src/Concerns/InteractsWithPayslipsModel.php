...
/**
 * Model-aware overloads for the `Payslips` resource.
 *
 ...
 * CRUD overloads with concrete `PayslipData` return types so static analysers
 ...
 * @see LaravelWafeq
 */
trait InteractsWithPayslipsModel
{
