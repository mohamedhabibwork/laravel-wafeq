...
/**
 * Model-aware overloads for the `SimplifiedInvoices` resource.
 *
 ...
 * CRUD overloads with concrete `SimplifiedInvoiceData` return types so static analysers
 ...
 * @see LaravelWafeq
 */
trait InteractsWithSimplifiedInvoicesModel
{
