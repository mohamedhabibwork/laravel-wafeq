...
/**
 * Model-aware overloads for the `SimplifiedInvoicesLineItems` resource.
 *
 ...
 * CRUD overloads with concrete `SimplifiedInvoiceLineItemData` return types so static analysers
 ...
 * @see LaravelWafeq
 */
trait InteractsWithSimplifiedInvoicesLineItemsModel
{
