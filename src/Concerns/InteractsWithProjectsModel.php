...
/**
 * Model-aware overloads for the `Projects` resource.
 *
 ...
 * CRUD overloads with concrete `ProjectData` return types so static analysers
 ...
 * @see LaravelWafeq
 */
trait InteractsWithProjectsModel
{
