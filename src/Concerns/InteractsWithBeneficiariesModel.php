...
/**
 * Model-aware overloads for the `Beneficiaries` resource.
 *
 ...
 * CRUD overloads with concrete `BeneficiaryData` return types so static analysers
 ...
 * @see LaravelWafeq
 */
trait InteractsWithBeneficiariesModel
{
