...
/**
 * Model-aware overloads for the `PurchaseOrdersLineItems` resource.
 *
 ...
 * CRUD overloads with concrete `PurchaseOrderLineItemData` return types so static analysers
 ...
 * @see LaravelWafeq
 */
trait InteractsWithPurchaseOrdersLineItemsModel
{
