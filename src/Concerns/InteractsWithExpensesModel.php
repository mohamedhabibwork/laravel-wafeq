...
/**
 * Model-aware overloads for the `Expenses` resource.
 *
 ...
 * CRUD overloads with concrete `ExpenseData` return types so static analysers
 ...
 * @see LaravelWafeq
 */
trait InteractsWithExpensesModel
{
