...
/**
 * Model-aware overloads for the `ApiCreditNotes` resource.
 *
 ...
 * CRUD overloads with concrete `ApiCreditNoteData` return types so static analysers
 ...
 * @see LaravelWafeq
 */
trait InteractsWithApiCreditNotesModel
{
