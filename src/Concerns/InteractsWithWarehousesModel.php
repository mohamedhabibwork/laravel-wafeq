...
/**
 * Model-aware overloads for the `Warehouses` resource.
 *
 ...
 * CRUD overloads with concrete `WarehouseData` return types so static analysers
 ...
 * @see LaravelWafeq
 */
trait InteractsWithWarehousesModel
{
