...
/**
 * Model-aware overloads for the `Invoices` resource.
 *
 ...
 * CRUD overloads with concrete `InvoiceData` return types so static analysers
 ...
 * @see LaravelWafeq
 */
trait InteractsWithInvoicesModel
{
