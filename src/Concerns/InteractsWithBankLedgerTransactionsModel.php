...
/**
 * Model-aware overloads for the `BankLedgerTransactions` resource.
 *
 ...
 * CRUD overloads with concrete `BankLedgerTransactionData` return types so static analysers
 ...
 * @see LaravelWafeq
 */
trait InteractsWithBankLedgerTransactionsModel
{
