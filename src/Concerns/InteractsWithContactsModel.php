...
/**
 * Model-aware overloads for the `Contacts` resource.
 *
 ...
 * CRUD overloads with concrete `ContactData` return types so static analysers
 ...
 * @see LaravelWafeq
 */
trait InteractsWithContactsModel
{
