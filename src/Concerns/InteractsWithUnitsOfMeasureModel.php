...
/**
 * Model-aware overloads for the `UnitsOfMeasure` resource.
 *
 ...
 * CRUD overloads with concrete `UnitOfMeasureData` return types so static analysers
 ...
 * @see LaravelWafeq
 */
trait InteractsWithUnitsOfMeasureModel
{
