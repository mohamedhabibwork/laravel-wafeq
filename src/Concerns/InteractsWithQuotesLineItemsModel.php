...
/**
 * Model-aware overloads for the `QuotesLineItems` resource.
 *
 ...
 * CRUD overloads with concrete `QuoteLineItemData` return types so static analysers
 ...
 * @see LaravelWafeq
 */
trait InteractsWithQuotesLineItemsModel
{
