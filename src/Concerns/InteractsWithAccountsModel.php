...
/**
 * Model-aware overloads for the `Accounts` resource.
 *
 ...
 * CRUD overloads with concrete `AccountData` return types so static analysers
 ...
 * @see LaravelWafeq
 */
trait InteractsWithAccountsModel
{
