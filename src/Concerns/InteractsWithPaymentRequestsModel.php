...
/**
 * Model-aware overloads for the `PaymentRequests` resource.
 *
 ...
 * CRUD overloads with concrete `PaymentRequestData` return types so static analysers
 ...
 * @see LaravelWafeq
 */
trait InteractsWithPaymentRequestsModel
{
