...
/**
 * Model-aware overloads for the `ItemUnitsOfMeasure` resource.
 *
 ...
 * CRUD overloads with concrete `ItemUnitOfMeasureData` return types so static analysers
 ...
 * @see LaravelWafeq
 */
trait InteractsWithItemUnitsOfMeasureModel
{
