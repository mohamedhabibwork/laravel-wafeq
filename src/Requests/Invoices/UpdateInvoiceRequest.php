...
/**
 * FormRequest for `PUT /invoices/{id}/` — Update invoice.
 *
 * Validation rules are derived from the OpenAPI schema in
 * `wafeq-docs/invoices_update.md`. The body shape is identical to
 * {@see CreateInvoiceRequest}; the operation is differentiated only
 * by HTTP verb and the `{id}` path parameter.
 *
 ...
 */
class UpdateInvoiceRequest extends WafeqFormRequest
{
