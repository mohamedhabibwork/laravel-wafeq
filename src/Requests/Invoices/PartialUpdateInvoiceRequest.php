...
/**
 * FormRequest for `PATCH /invoices/{id}/` — Partial update invoice.
 *
 * Validation rules are derived from the OpenAPI schema in
 * `wafeq-docs/invoices_partial_update.md`. The schema is identical to
 * {@see CreateInvoiceRequest}; partial updates are flagged by PATCH
 * and the server treats absent fields as no-ops.
 *
 ...
 */
class PartialUpdateInvoiceRequest extends WafeqFormRequest
{
