...
/**
 * FormRequest for `POST /bank-accounts/` — Create bank account.
 *
 * Validation rules are derived from the OpenAPI schema in
 * `wafeq-docs/bank_accounts_create.md`.
 *
 ...
 */
class CreateBankAccountRequest extends WafeqFormRequest
{
    ...
    {
        return [
            // ISO-4217 currency code — the DTO cast handles enum mapping
            // for the 115 supported codes; this rule keeps the wire
