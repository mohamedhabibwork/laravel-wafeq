...
/**
 * FormRequest for `PATCH /quotes/{id}/` — Partial update quote.
 *
 * Validation rules are derived from the OpenAPI schema in
 * `wafeq-docs/quotes_partial_update.md`. The schema is identical to
 * {@see CreateQuoteRequest}; partial updates are flagged by PATCH and
 * the server treats absent fields as no-ops.
 *
 ...
 */
class PartialUpdateQuoteRequest extends WafeqFormRequest
{
