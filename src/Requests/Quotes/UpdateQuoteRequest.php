...
/**
 * FormRequest for `PUT /quotes/{id}/` — Update quote.
 *
 * Validation rules are derived from the OpenAPI schema in
 * `wafeq-docs/quotes_update.md`. The body shape is identical to
 * {@see CreateQuoteRequest}; the operation is differentiated only by
 * HTTP verb and the `{id}` path parameter.
 *
 ...
 */
class UpdateQuoteRequest extends WafeqFormRequest
{
