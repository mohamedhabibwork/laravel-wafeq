 ...
 * `wafeq-docs/bank_accounts_ledger_transactions_update.md`. The schema
 * is identical to the create endpoint, so the ruleset matches
 * `CreateBankLedgerTransactionRequest` one-to-one.
 *
 ...
 */
class UpdateBankLedgerTransactionRequest extends WafeqFormRequest
{
