...
/**
 * FormRequest for `POST /credit-notes/{credit_note_id}/line-items/` — Create credit note line item.
 *
 * Validation rules are derived from the OpenAPI schema in
 * `wafeq-docs/credit_notes_line_items_create.md`. Server-managed
 ...
 */
class CreateCreditNoteLineItemRequest extends WafeqFormRequest
{
