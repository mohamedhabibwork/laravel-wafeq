...
/**
 * FormRequest for `PATCH /credit-notes/{credit_note_id}/line-items/{id}/` — Partial update credit note line item.
 *
 * Validation rules are derived from the OpenAPI schema in
 * `wafeq-docs/credit_notes_line_items_partial_update.md`. The
 * `PatchedCreditNoteLineItem` schema defines no `required` array, so
 ...
 */
class PartialUpdateCreditNoteLineItemRequest extends WafeqFormRequest
{
