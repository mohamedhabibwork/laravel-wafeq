...
/**
 * FormRequest for `PUT /simplified-invoices/{id}/` — Update simplified invoice.
 *
 * Validation rules are derived from the OpenAPI schema in
 * `wafeq-docs/simplified_invoices_update.md`. The body shape is
 * identical to {@see CreateSimplifiedInvoiceRequest}; the operation
 * is differentiated only by HTTP verb and the `{id}` path parameter.
 *
 ...
 */
class UpdateSimplifiedInvoiceRequest extends WafeqFormRequest
{
