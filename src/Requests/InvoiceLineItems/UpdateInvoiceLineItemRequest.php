...
/**
 * FormRequest for `PUT /invoices/{invoice_id}/line-items/{id}/`
 * — Update invoice line item.
 *
 * Validation rules are derived from the OpenAPI schema in
 * `wafeq-docs/invoices_line_items_update.md`. The body shape is
 * identical to {@see CreateInvoiceLineItemRequest}; the operation is
 * differentiated only by HTTP verb and the `{id}` path parameter.
 *
 ...
 */
class UpdateInvoiceLineItemRequest extends WafeqFormRequest
{
