...
/**
 * FormRequest for `PUT /expenses/{id}/` — Update expense.
 *
 * Validation rules are derived from the OpenAPI schema in
 * `wafeq-docs/expenses_update.md`. The schema's `required` array also
 * lists server-managed (`readOnly`) fields like `id`, `status`,
 * `created_ts`, `modified_ts`, `legacy_id`; those are filtered out and
 ...
 */
class UpdateExpenseRequest extends WafeqFormRequest
{
