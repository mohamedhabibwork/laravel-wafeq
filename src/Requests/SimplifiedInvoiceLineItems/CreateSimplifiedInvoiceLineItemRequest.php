...
/**
 * FormRequest for `POST /simplified-invoices/{invoice_id}/line-items/`
 * — Create simplified invoice line item.
 *
 * Validation rules are derived from the OpenAPI schema in
 * `wafeq-docs/simplified_invoices_line_items_create.md`.
 *
 ...
 */
class CreateSimplifiedInvoiceLineItemRequest extends WafeqFormRequest
{
