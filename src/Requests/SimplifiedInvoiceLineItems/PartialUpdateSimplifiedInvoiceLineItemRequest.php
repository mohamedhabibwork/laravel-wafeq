...
/**
 * FormRequest for `PATCH /simplified-invoices/{invoice_id}/line-items/{id}/`
 * — Partial update simplified invoice line item.
 *
 * Validation rules are derived from the OpenAPI schema in
 * `wafeq-docs/simplified_invoices_line_items_partial_update.md`. The
 * schema is identical to {@see CreateSimplifiedInvoiceLineItemRequest};
 * partial updates are flagged by PATCH and the server treats absent
 * fields as no-ops.
 *
 ...
 */
class PartialUpdateSimplifiedInvoiceLineItemRequest extends WafeqFormRequest
{
