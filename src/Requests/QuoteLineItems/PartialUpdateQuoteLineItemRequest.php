...
/**
 * FormRequest for `PATCH /quotes/{quote_id}/line-items/{id}/`
 * — Partial update quote line item.
 *
 * Validation rules are derived from the OpenAPI schema in
 * `wafeq-docs/quotes_line_items_partial_update.md`. The schema is
 * identical to {@see CreateQuoteLineItemRequest}; partial updates are
 * flagged by PATCH and the server treats absent fields as no-ops.
 *
 ...
 */
class PartialUpdateQuoteLineItemRequest extends WafeqFormRequest
{
