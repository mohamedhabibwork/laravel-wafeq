...
/**
 * FormRequest for `PUT /quotes/{quote_id}/line-items/{id}/`
 * — Update quote line item.
 *
 * Validation rules are derived from the OpenAPI schema in
 * `wafeq-docs/quotes_line_items_update.md`. The body shape is
 * identical to {@see CreateQuoteLineItemRequest}; the operation is
 ...
 */
class UpdateQuoteLineItemRequest extends WafeqFormRequest
{
