...
/**
 * FormRequest for `PATCH /debit-notes/{debit_note_id}/line-items/{id}/` — Partial update debit note line item.
 *
 * Validation rules are derived from the OpenAPI schema in
 * `wafeq-docs/debit_notes_line_items_partial_update.md`. The
 * `PatchedDebitNoteLineItem` schema defines no `required` array, so
 ...
 */
class PartialUpdateDebitNoteLineItemRequest extends WafeqFormRequest
{
