...
/**
 * FormRequest for `PUT /debit-notes/{debit_note_id}/line-items/{id}/` — Update debit note line item.
 *
 * Validation rules are derived from the OpenAPI schema in
 * `wafeq-docs/debit_notes_line_items_update.md`. Server-managed
 ...
 */
class UpdateDebitNoteLineItemRequest extends WafeqFormRequest
{
