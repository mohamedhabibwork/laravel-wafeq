...
/**
 * FormRequest for `PATCH /purchase-orders/{purchase_order_id}/line-items/{id}/` — Partial update purchase order line item.
 *
 * Validation rules are derived from the OpenAPI schema in
 * `wafeq-docs/purchase_orders_line_items_partial_update.md`. The
 * `PatchedPurchaseOrderLineItem` schema defines no `required` array, so
 * every field is treated as optional — clients only send the keys they
 * want to mutate.
 *
 ...
 *
 * Server-managed (`readOnly`) properties (`id`, `line_amount`,
 ...
 */
class PartialUpdatePurchaseOrderLineItemRequest extends WafeqFormRequest
{
