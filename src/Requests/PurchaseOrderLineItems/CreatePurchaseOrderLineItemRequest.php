...
/**
 * FormRequest for `POST /purchase-orders/{purchase_order_id}/line-items/` — Create purchase order line item.
 *
 * Validation rules are derived from the OpenAPI schema in
 * `wafeq-docs/purchase_orders_line_items_create.md`. Server-managed
 ...
 */
class CreatePurchaseOrderLineItemRequest extends WafeqFormRequest
{
