...
namespace HWafeq\LaravelWafeq\Requests\ApiCreditNotes;
...
/**
 * FormRequest for `POST /api-credit-notes/bulk-send/`
 * — Send credit notes in bulk.
 *
 * Validation rules are derived from the OpenAPI schema in
 * `wafeq-docs/api_credit_notes_bulk_send_create.md`.
 *
 * The endpoint's request body shape (`BulkSendAPICreditNote`):
 *
 ...
 * `price`, `quantity`.
 */
class CreateApiCreditNoteBulkSendRequest extends WafeqFormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // Caller-provided credit note number.
    ...
    {
        return ApiCreditNoteData::class;
    }
}
