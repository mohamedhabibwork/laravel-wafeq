...
/**
 * FormRequest for `PUT /payslips/{id}/` — Update payslip.
 *
 * Validation rules are derived from the OpenAPI schema in
 * `wafeq-docs/payslips_update.md`. The `Payslip` schema used here is
 * identical to the create endpoint, so the ruleset matches
 * `CreatePayslipRequest` one-to-one.
 *
 ...
 * client-sent.
 */
class UpdatePayslipRequest extends WafeqFormRequest
{
