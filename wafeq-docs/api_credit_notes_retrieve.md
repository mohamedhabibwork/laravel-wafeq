...
Endpoint for retrieving a single credit note (bulk).
...
```json
{
  ...
  "paths": {
    "/api-credit-notes/{id}/": {
      "get": {
        "description": "Endpoint for retrieving a single credit note (bulk).",
        "operationId": "api_credit_notes_retrieve",
        "parameters": [
          {
            "in": "path",
            "name": "id",
        ...
        "summary": "Retrieve credit note (bulk)",
        "tags": [
          "Credit Notes (Bulk)"
        ]
      }
