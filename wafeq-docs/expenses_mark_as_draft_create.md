---
updatedAt: 2026-08-10T10:56:25.000Z
---
...
```json
{
  ...
  "openapi": "3.1.1",
  "paths": {
    "/expenses/{id}/mark-as-draft/": {
      "post": {
        "description": "Moves a posted expense back to draft (removes its journal from the ledger).",
        "operationId": "expenses_mark_as_draft_create",
        "parameters": [
          {
            "in": "path",
            "name": "id",
