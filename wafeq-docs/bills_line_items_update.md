...
Endpoint for updating an existing bill line item.
...
```json
{
  ...
  "paths": {
    "/bills/{bill_id}/line-items/{id}/": {
      "put": {
        "description": "Endpoint for updating an existing bill line item.",
        "operationId": "bills_line_items_update",
        "parameters": [
          {
