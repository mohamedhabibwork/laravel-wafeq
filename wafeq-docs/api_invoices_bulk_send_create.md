...
This endpoint can be used to send invoices in large volumes.
...
```json
{
    ...
    "schemas": {
      ...
      "BulkSendAPIInvoice": {
        "properties": {
          ...
          "line_items": {
            "items": {
              "$ref": "#/components/schemas/BulkSendAPIInvoiceLineItem"
            },
            "maxItems": 100,
            "minItems": 1,
            "type": "array"
  ...
  "paths": {
    "/api-invoices/bulk_send/": {
      "post": {
        "description": "This endpoint can be used to send invoices in large volumes.",
        "operationId": "api_invoices_bulk_send_create",
        "requestBody": {
          "content": {
            "application/json": {
              "examples": {
              ...
              "schema": {
                "$ref": "#/components/schemas/BulkSendAPIInvoice"
              }
            },
