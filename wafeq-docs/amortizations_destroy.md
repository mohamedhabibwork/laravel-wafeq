...
Endpoint for deleting an existing amortization.
...
```json
{
  ...
  "paths": {
    "/amortizations/{id}/": {
      "delete": {
        "description": "Endpoint for deleting an existing amortization.",
        "operationId": "amortizations_destroy",
        "parameters": [
          {
