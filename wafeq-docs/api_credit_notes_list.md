...
Endpoint for retrieving a list of credit notes (bulk).
...
```json
{
    ...
    "schemas": {
      "APICreditNote": {
        "properties": {
          ...
          "line_items": {
            "items": {
              "$ref": "#/components/schemas/APICreditNoteLineItem"
            },
            "maxItems": 100,
            "minItems": 1,
            "type": "array"
      ...
      "PaginatedAPICreditNoteList": {
        "properties": {
          ...
          "results": {
            "items": {
              "$ref": "#/components/schemas/APICreditNote"
            },
            "type": "array"
          }
        },
  ...
  "paths": {
    "/api-credit-notes/": {
      "get": {
        "description": "Endpoint for retrieving a list of credit notes (bulk).",
        "operationId": "api_credit_notes_list",
        "parameters": [
          {
        ...
        "responses": {
          "200": {
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/PaginatedAPICreditNoteList"
                }
              }
            },
            "description": ""
        ...
        "summary": "List credit notes (bulk)",
        "tags": [
          "Credit Notes (Bulk)"
        ]
      }
