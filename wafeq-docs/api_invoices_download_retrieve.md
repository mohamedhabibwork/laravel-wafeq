...
# Download invoice (bulk) PDF

Endpoint for downloading a PDF of the invoice (bulk).
...
```json
{
  ...
  "paths": {
    "/api-invoices/{id}/download/": {
      "get": {
        "description": "Endpoint for downloading a PDF of the invoice (bulk).",
        "operationId": "api_invoices_download_retrieve",
        "parameters": [
          {
            "in": "path",
            "name": "id",
        ...
        "summary": "Download invoice (bulk) PDF",
        "tags": [
          "Invoices (Bulk)"
        ]
      }
