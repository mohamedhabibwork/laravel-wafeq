...
# Download credit note (bulk) PDF

Endpoint for downloading a PDF of the credit note (bulk).
...
```json
{
  ...
  "openapi": "3.1.1",
  "paths": {
    "/api-credit-notes/{id}/download/": {
      "get": {
        "description": "Endpoint for downloading a PDF of the credit note (bulk).",
        "operationId": "api_credit_notes_download_retrieve",
        "parameters": [
          {
            "in": "path",
            "name": "id",
        ...
        "summary": "Download credit note (bulk) PDF",
        "tags": [
          "Credit Notes (Bulk)"
        ]
      }
