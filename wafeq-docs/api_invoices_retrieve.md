...
# Retrieve invoice (bulk)

Endpoint for retrieving a single invoice (bulk).
...
```json
{
  ...
  "paths": {
    "/api-invoices/{id}/": {
      "get": {
        "description": "Endpoint for retrieving a single invoice (bulk).",
