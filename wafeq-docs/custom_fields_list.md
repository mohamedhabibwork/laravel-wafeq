...
Endpoint for retrieving a list of custom fields.
...
```json
{
  "components": {
    "schemas": {
      ...
      "Paginatedapi-v1-external-custom-field-readList": {
        "properties": {
          "count": {
            "example": 123,
            "type": "integer"
  ...
  "paths": {
    "/custom-fields/": {
      "get": {
        "description": "Endpoint for retrieving a list of custom fields.",
        ...
        "responses": {
          "200": {
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/Paginatedapi-v1-external-custom-field-readList"
                }
              }
            },
            "description": ""
