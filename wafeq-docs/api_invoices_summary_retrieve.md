...
Generates summary invoices equivalent to all the bulk invoices.
...
```json
{
  ...
  "paths": {
    "/api-invoices/summary/": {
      "get": {
        "description": "Generates summary invoices equivalent to all the bulk invoices.",
        "operationId": "api_invoices_summary_retrieve",
        "responses": {
          "200": {
            "content": {
              "application/json": {
        ...
        "summary": "Generate Summary Invoice",
        "tags": [
          "Invoices (Bulk)"
        ]
      }
