...
use HWafeq\LaravelWafeq\Requests\QuoteLineItems\UpdateQuoteLineItemRequest;
use Illuminate\Routing\Redirector;
use Illuminate\Support\Facades\Validator;

it('validates a fully-populated quote line item payload for PUT', function () {
    $payload = [
        'description' => 'Service',
        'quantity' => '2.5',
        'unit_amount' => '150.00',
    ...
    $request = UpdateQuoteLineItemRequest::create('/quotes/q_1/line-items/li_1/', 'PUT', $payload);
...
it('rejects a PUT payload missing required fields', function () {
    $request = UpdateQuoteLineItemRequest::create('/quotes/q_1/line-items/li_1/', 'PUT', []);
    $request->setContainer($this->app);
    $request->setRedirector($this->app->make(Redirector::class));
